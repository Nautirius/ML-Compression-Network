...
def collect_and_save_metrics(root_folder: str, output_file: str):
    """Zbiera dane testowe wszystkich modeli w jeden plik JSON."""
    aggregated_metrics = []
...
if __name__ == '__main__':
    collect_and_save_metrics("tests", "aggregated_metrics.json")
